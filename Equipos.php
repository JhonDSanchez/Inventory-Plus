    ...
    <div class="table-container">
            ...
            <?php foreach ($equipos as $eq): ?>
              <tr>
                ...
                <td class="action-buttons">
                    <a href="./Data/Data_Equipos/EditarEquipo.php?id=<?php echo $eq["id"]; ?>" class="editButton" title="Editar Equipos">
      ...
      <div class="PaginationDiv">
        ...
        <?php if (isset($_COOKIE["RoleDB"]) && ($_COOKIE["RoleDB"] == "Administrador" || $_COOKIE["RoleDB"] == "Coordinador")) : ?>
            <a href="./Data/Data_Equipos/AñadirEquipo.php" class="addButton">Agregar Equipo</a>
        <?php endif; ?>      
    </div>
  </article>
</section>
